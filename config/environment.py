...
SWOT_CACHE_DIR = os.getenv("SWOT_CACHE_DIR", "data/artifacts/swot_cache")
...
DSPY_NUM_RETRIES = int(os.getenv("DSPY_NUM_RETRIES", "30"))  # Retries with exponential backoff
...
def get_swot_settings() -> dict[str, Any]:
    ...
    return {
        ...
        "cache_dir": SWOT_CACHE_DIR,
        "cache_ttl_days": SWOT_CACHE_TTL_DAYS,
        "max_concurrent": SWOT_MAX_CONCURRENT,
